...
и в прочем везде где есть очередь.  
...
Система должна взаимодействовать с подписчиками в чатах. Подразумевается, что чат будет называться фамилией и именем посетителя.  

...
Стоит отметить, что администраторы могут назначаться с разрешения высшего администратора или автора.
